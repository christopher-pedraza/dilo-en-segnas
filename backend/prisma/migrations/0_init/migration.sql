...
CREATE TABLE "isla" (
    ...
    "modelo_general" BYTEA NOT NULL,
    "modelo_especifico" BYTEA NOT NULL,
...
-- AddForeignKey
ALTER TABLE "respuestas_video_cuestionario" ADD CONSTRAINT "respuestas_video_cuestionario_id_parte_video_cuestionario_fkey" FOREIGN KEY ("id_parte_video_cuestionario") REFERENCES "parte_video_cuestionario"("id_parte_video_cuestionario") ON DELETE NO ACTION ON UPDATE NO ACTION;
