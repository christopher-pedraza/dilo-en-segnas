...
CREATE TABLE "palabras_video_cuestionario" (
    ...
    CONSTRAINT "palabras_video_cuestionario_pkey" PRIMARY KEY ("id_parte_video_cuestionario","id_palabra")
);
...
CREATE TABLE "respuestas_video_cuestionario" (
    ...
    -- "id_parte_video_cuestionario" INTEGER,
...
-- AddForeignKey
ALTER TABLE "palabras_video_cuestionario" ADD CONSTRAINT "palabras_video_cuestionario_id_parte_video_cuestionario_fkey" FOREIGN KEY ("id_parte_video_cuestionario") REFERENCES "parte_video_cuestionario"("id_parte_video_cuestionario") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
-- ALTER TABLE "respuestas_video_cuestionario" ADD CONSTRAINT "respuestas_video_cuestionario_id_parte_video_cuestionario_fkey" FOREIGN KEY ("id_parte_video_cuestionario") REFERENCES "parte_video_cuestionario"("id_parte_video_cuestionario") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- RemoveColumn
ALTER TABLE "respuestas_video_cuestionario" DROP COLUMN "id_parte_video_cuestionario"